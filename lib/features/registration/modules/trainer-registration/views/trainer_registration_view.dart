...
import 'package:taekwondo/features/registration/modules/trainer-registration/views/components/trainer_address.dart';
import 'package:taekwondo/features/registration/modules/trainer-registration/views/components/trainer_personal.dart';
import 'package:taekwondo/features/registration/modules/payment/views/payment_view.dart';

class TrainerRegistrationView extends StatefulWidget {
  const TrainerRegistrationView({super.key});

  @override
  TrainerRegistrationViewState createState() => TrainerRegistrationViewState();
}

class TrainerRegistrationViewState extends State<TrainerRegistrationView> {
  int activeStep = 0;
  final List<String> stepTitles = ['Personal', 'Dojang', 'Pembayaran'];
