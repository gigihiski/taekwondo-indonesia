...
import 'package:taekwondo/features/registration/modules/refree-registration/views/components/refree_address.dart';
import 'package:taekwondo/features/registration/modules/refree-registration/views/components/refree_personal.dart';
import 'package:taekwondo/features/registration/modules/payment/views/payment_view.dart';

class RefreeRegistrationView extends StatefulWidget {
  const RefreeRegistrationView({super.key});

  @override
  RefreeRegistrationViewState createState() => RefreeRegistrationViewState();
}

class RefreeRegistrationViewState extends State<RefreeRegistrationView> {
  int activeStep = 0;
  ...
  Widget buildStepContent() {
    switch (activeStep) {
      case 0:
        return RefreePersonal();
      case 1:
        return RefreeAddress();
      case 2:
        return PaymentView();
      default:
        return RefreePersonal();
